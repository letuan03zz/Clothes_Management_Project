package letuan.dmt.clothes_management_project.adapter;
...
import letuan.dmt.clothes_management_project.MainActivity;
import letuan.dmt.clothes_management_project.R;
import letuan.dmt.clothes_management_project.entity.Product;
import letuan.dmt.clothes_management_project.services.ProductAPIServices;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    Retrofit retrofit = new Retrofit.Builder()
            .baseUrl("http://10.0.2.2:8080/clothes/rest/")
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        String imagePath = "http://10.0.2.2:8080/clothes/img/"+product.getImage();
